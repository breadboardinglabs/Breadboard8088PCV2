;=========================================================================
; monitorledkeytestv4.asm - Test Breadboard PC 7 Segment Display and NeoKey Pad loaded from Monitor Load at [7000:0000]
; Based on Reset code and macro from XI 8088 BIOS code by Sergey Kiselev
; nasm -f srec -o monitorledkeytestv4.srec -l monitorledkeytestv4.lst monitorledkeytestv4.asm
;
...
%define	DBUF		0xEFF0		; Display Buffer DBUF starts at offset EFF0 Physical Address is 7EFF0 [7000:EFF0] at top of 512K RAM separate from ROM monitor
...
test_start:
    ...
    mov sp, 0xEF00 ; Stack starts at 0x7EF00 downwards [7000:EF00] leaving 256 bytes for Monitor working memory
    xor di, di
    xor si, si
    mov ax, 0
    mov bx, 0
