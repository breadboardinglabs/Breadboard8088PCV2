;=========================================================================
; ledkeytestv2.asm - Test Breadboard PC 7 Segment Display and NeoKey Pad
; Based on Reset code and macro from XI 8088 BIOS code by Sergey Kiselev
; nasm -f bin -o ledkeytestv2.bin -l ledkeytestv2.lst ledkeytestv2.asm
;
...
;   Wait for the key to be released
    push ax           ; Save keycode in ah
                      ; Use cx for Y and B
    mov cx, 0x0800    ;                     ldy      #$08              ; Keybounce delay will be 8 (Y) x 256 (B), 2048 loops
getkey5:
...
getkey6:
    ...
    dec cx            ; Key released, decrement count
