;=========================================================================
; testramv2.asm - Test Breadboard PC V2 RAM and ROM
; Based on XI 8088 Bios code by Sergey Kiselev
; nasm -f bin -o testramv2.bin -l testramv2.lst testramv2.asm
;
; Writes 8 bit ascending byte to addresses 00000 - 9FFFF (first 640K)
...
%define	START		0x8000		; BIOS starts at offset 8000h Physical Address is F8000 [F000:8000]
%define	TOPRAM		0xA000		; Top of 640K of RAM    
...
fill_memory:
    ...
    ; Repeat until all of memory is filled when DS=A000 (done 0000 - 9000)
    cmp ax, TOPRAM
    jne fill_memory
